...
-- ============================================================================
-- Source: @magicwizards/outreach package (OUTREACH_MIGRATION_SQL)
-- This migration creates the tables, indexes, and triggers required by the
-- outreach wizard system for campaign management, lead tracking, email
-- sequencing, and email provider configuration.
