            ...
            <form onSubmit={handleCreateTenant} className="p-6 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <select
                    value={formData.default_wizard_id ?? ""}
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        default_wizard_id: e.target.value || null,
                      })
                    }
                    className="w-full rounded-lg border border-gray-300 px-3 py-2 text-gray-900 dark:border-gray-700 dark:bg-gray-800 dark:text-white"
                  >
                    <option value="">App default (Builder)</option>
                    <option value="builder">Builder Wizard</option>
                    <option value="research">Research Wizard</option>
                    <option value="ops">Ops Wizard</option>
                    <option value="sales">Sales Wizard</option>
                    <option value="outreach">Outreach Wizard</option>
